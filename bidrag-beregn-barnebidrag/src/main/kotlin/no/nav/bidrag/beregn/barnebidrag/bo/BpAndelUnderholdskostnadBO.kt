...
data class BpAndelUnderholdskostnadPeriodeGrunnlag(
    ...
    val underholdskostnadPeriodeGrunnlagListe: List<UPeriodeGrunnlag>,
...
data class UPeriodeGrunnlag(val referanse: String, val underholdskostnadPeriode: UnderholdskostnadPeriode)
