...
class BeregnBarnebidragService : BeregnService() {
    ...
    fun beregnNettoBarnetillegg(mottattGrunnlag: BeregnGrunnlag): List<GrunnlagDto> {
        ...
        // Kaller delberegninger
        val delberegningNettoBarnetilleggResultat = delberegningNettoBarnetillegg(mottattGrunnlag)
