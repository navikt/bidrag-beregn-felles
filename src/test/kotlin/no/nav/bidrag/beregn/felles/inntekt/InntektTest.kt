...
internal class InntektTest {
    ...
    fun testUtvidetBarnetrygdFullTest() {
        ...
        assertAll(
            ...
            Executable { assertThat(nyInntektGrunnlagListe[9].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[10].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[11].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[12].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[13].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
    ...
    fun testUtvidetBarnetrygdOvergangSkatteklasse2FordelSaerfradrag() {
        ...
        assertAll(
            ...
            Executable { assertThat(nyInntektGrunnlagListe[2].type).isEqualTo(InntektType.FORDEL_SKATTEKLASSE2) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[3].type).isEqualTo(InntektType.FORDEL_SKATTEKLASSE2) },
            ...
            Executable { assertThat(nyInntektGrunnlagListe[4].type).isEqualTo(InntektType.FORDEL_SAERFRADRAG_ENSLIG_FORSORGER) },
