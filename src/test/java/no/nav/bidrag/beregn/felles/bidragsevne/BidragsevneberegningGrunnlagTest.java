...
class BidragsevneberegningGrunnlagTest {
    ...
    void hentSjablon() {
        ...
        sjabloner.add(new Sjablon("MinstefradragBelop", Double.valueOf(85500), null));
        ...
        sjabloner.add(new Sjablon("Skattesats", Double.valueOf(0.22), null));
        sjabloner.add(new Sjablon("SatsTrygdeavgift", Double.valueOf(0.082), null));
