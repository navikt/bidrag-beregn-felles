...
public class InntektTest {
  ...
  void testUgyldigSoknadstype() {
    var inntektGrunnlagListe = Collections
        .singletonList(new InntektGrunnlag(new Periode(LocalDate.parse("2019-01-01"), LocalDate.parse("9999-12-31")),
            InntektType.AINNTEKT_KORRIGERT_BARNETILLEGG, BigDecimal.valueOf(200000)));
  ...
  void testUgyldigFraDato() {
    ...
    assertAll(
        ...
        () -> assertThat(avvikListe.get(0).getAvvikTekst()).isEqualTo("inntektType " + InntektType.AINNTEKT_KORRIGERT_BARNETILLEGG.toString() +
            ...
            InntektType.AINNTEKT_KORRIGERT_BARNETILLEGG.getGyldigTom().toString())
    );
  }
  ...
  void testJusterDelvisOverlappSammeGruppe() {
    ...
    assertAll(
        ...
        () -> assertThat(inntektGrunnlagListe.get(0).getInntektType()).isEqualTo(InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER),
        ...
        () -> assertThat(inntektGrunnlagListe.get(1).getInntektType()).isEqualTo(InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER),
        ...
        () -> assertThat(inntektGrunnlagListe.get(4).getInntektType()).isEqualTo(InntektType.KAPITALINNTEKT_EGNE_OPPLYSNINGER),
