...
class SjablonTest {
  ...
  void testHentSjablontall() {
    ...
    var sjablonVerdi = SjablonUtil
        .hentSjablontall(sjablonListe, SjablonTallNavn.BOUTGIFTER_BIDRAGSBARN_BELOP.getNavn(), SjablonInnholdNavn.SJABLON_VERDI.getNavn());
  ...
  void testHentTrinnvisSkattesatsKalkulasjon() {
    ...
    assertThat(trinnvisSkattesatsKalkulasjon(100000d)).isEqualTo(0d);
    assertThat(trinnvisSkattesatsKalkulasjon(200000d)).isEqualTo(365d);
    assertThat(trinnvisSkattesatsKalkulasjon(500000d)).isEqualTo(11711d);
    assertThat(trinnvisSkattesatsKalkulasjon(800000d)).isEqualTo(38734d);
    assertThat(trinnvisSkattesatsKalkulasjon(1000000d)).isEqualTo(65148d);

    assertThat(trinnvisSkattesatsKalkulasjon(100000d)).isEqualTo(trinnvisSkattesatsKalkulasjonGammel(100000d));
    assertThat(trinnvisSkattesatsKalkulasjon(200000d)).isEqualTo(trinnvisSkattesatsKalkulasjonGammel(200000d));
    assertThat(trinnvisSkattesatsKalkulasjon(500000d)).isEqualTo(trinnvisSkattesatsKalkulasjonGammel(500000d));
    assertThat(trinnvisSkattesatsKalkulasjon(800000d)).isEqualTo(trinnvisSkattesatsKalkulasjonGammel(800000d));
    assertThat(trinnvisSkattesatsKalkulasjon(1000000d)).isEqualTo(trinnvisSkattesatsKalkulasjonGammel(1000000d));
  }

  private double trinnvisSkattesatsKalkulasjon(double inntekt) {
