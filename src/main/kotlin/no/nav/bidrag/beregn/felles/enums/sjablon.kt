...
enum class SjablonTallNavn(val navn: String, val id: String, val bidragsevne: Boolean, val nettoBarnetilsyn: Boolean, val underholdskostnad: Boolean,
    val bpAndelUnderholdskostnad: Boolean, val barnebidrag: Boolean, val forskudd: Boolean, val bpAndelSaertilskudd: Boolean,
  ...
  FORDEL_SKATTEKLASSE2_BELOP("FordelSkatteklasse2Beløp", "0004", true, false, false, true, false, false, false, false),
  ...
  BARNETILLEGG_FORSVARET_FORSTE_BARN_BELOP("BarnetilleggForsvaretFørsteBarnBeløp", "0021", false, false, false, false, true, false, false, true),
  BARNETILLEGG_FORSVARET_OVRIGE_BARN_BELOP("BarnetilleggForsvaretØvrigeBarnBeløp", "0022", false, false, false, false, true, false, false, true),
  ...
  OVRE_INNTEKTSGRENSE_IKKE_I_SKATTEPOSISJON_BELOP("ØvreInntektsgrenseIkkeISkatteposisjonBeløp", "0030", false, false, false, true, false, false, false, false),
  NEDRE_INNTEKTSGRENSE_FULL_SKATTEPOSISJON_BELOP("NedreInntektsgrenseFullSkatteposisjonBeløp", "0031", false, false, false, true, false, false, false, false),
  ...
  FORDEL_SAERFRADRAG_BELOP("FordelSærfradragBeløp", "0039", true, false, false, true, false, false, false, false),
