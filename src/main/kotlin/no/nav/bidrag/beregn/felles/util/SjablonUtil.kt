...
object SjablonUtil {
    ...
    fun hentSjablonverdi(
        ...
        val filtrertSjablonListe = filtrerSjablonNokkelListePaaSjablonNokkel(
    ...
    fun hentSjablonverdi(
        ...
        val sortertSjablonSingelNokkelListe = mapTilSingelListeNokkelSortert(
            filtrertSjablonListe = filtrertSjablonListe,
            sjablonNokkelNavn = sjablonNokkelNavn
        )
        val sjablonInnholdListe = finnSjablonInnholdVerdiListeIntervall(
    ...
    fun hentSjablonverdi(sjablonListe: List<Sjablon>, sjablonTallNavn: SjablonTallNavn): BigDecimal {
        ...
        val sjablonInnholdListe = mapSjablonListeTilSjablonInnholdListe(filtrertSjablonListe)
        return hentSjablonInnholdVerdiEksakt(sjablonInnholdListe = sjablonInnholdListe, sjablonInnholdNavn = SjablonInnholdNavn.SJABLON_VERDI)
    }
    ...
    private fun filtrerPaaSjablonNavn(sjablonListe: List<Sjablon>, sjablonNavn: String) =
    ...
    // Intern bruk.
    private fun filtrerPaaSjablonNokkel(sjablonStream: Stream<Sjablon>, sjablonNokkelInput: SjablonNokkel) =
    ...
    private fun mapSjablonListeTilSjablonInnholdListe(sjablonListe: List<Sjablon>) =
        sjablonListe.flatMap { it.innholdListe }
    ...
    private fun mapTilSingelListeNokkelSortert(filtrertSjablonListe: List<Sjablon>, sjablonNokkelNavn: SjablonNokkelNavn): List<SjablonSingelNokkel> =
        filtrertSjablonListe
            .map {
                SjablonSingelNokkel(
                    navn = it.navn,
                    verdi = it.nokkelListe!!
    ...
    private fun hentSjablonInnholdVerdiEksakt(sjablonInnholdListe: List<SjablonInnhold>, sjablonInnholdNavn: SjablonInnholdNavn) =
        sjablonInnholdListe
    ...
    private fun finnSjablonInnholdVerdiListe(sjablonInnholdListe: List<SjablonInnhold>, sjablonInnholdNavn: SjablonInnholdNavn) =
        sjablonInnholdListe
            .filter { it.navn == sjablonInnholdNavn.navn }
            .map { it.verdi }
            .toList()
