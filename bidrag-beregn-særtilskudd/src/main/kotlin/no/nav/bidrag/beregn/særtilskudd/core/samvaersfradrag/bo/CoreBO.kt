package no.nav.bidrag.beregn.særtilskudd.core.samvaersfradrag.bo
...
// Resultatperiode
data class BeregnSamvaersfradragResultat(val resultatPeriodeListe: List<ResultatPeriode>)
...
data class ResultatBeregning(val barnPersonId: Int, val belop: BigDecimal, val sjablonListe: List<SjablonPeriodeNavnVerdi>)
...
data class SamvaersfradragGrunnlagPerBarn(val referanse: String, val barnPersonId: Int, val barnAlder: Int, val samvaersklasse: String)
