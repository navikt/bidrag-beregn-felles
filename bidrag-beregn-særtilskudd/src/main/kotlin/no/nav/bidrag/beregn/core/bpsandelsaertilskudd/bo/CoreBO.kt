package no.nav.bidrag.beregn.core.bpsandelsaertilskudd.bo
...
// Resultatperiode
data class BeregnBPsAndelSaertilskuddResultat(val resultatPeriodeListe: List<ResultatPeriode>)
...
data class Inntekt(val referanse: String, val inntektType: String, val inntektBelop: BigDecimal, val deltFordel: Boolean, val skatteklasse2: Boolean)
