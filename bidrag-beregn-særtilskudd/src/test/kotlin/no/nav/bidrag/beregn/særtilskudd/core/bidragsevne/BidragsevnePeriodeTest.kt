...
internal class BidragsevnePeriodeTest {
    ...
    fun testGrunnlagOk() {
        ...
        assertAll(
            ...
            { assertThat(resultat.resultatPeriodeListe[0].resultat.belop).isEqualTo(BigDecimal.valueOf(3749)) },
            ...
            { assertThat(resultat.resultatPeriodeListe[1].resultat.belop).isEqualTo(BigDecimal.valueOf(15604)) },
            ...
            { assertThat(resultat.resultatPeriodeListe[2].resultat.belop).isEqualTo(BigDecimal.valueOf(20536)) },
            ...
            { assertThat(resultat.resultatPeriodeListe[3].resultat.belop).isEqualTo(BigDecimal.valueOf(20536)) },
            ...
            { assertThat(resultat.resultatPeriodeListe[4].resultat.belop).isEqualTo(BigDecimal.valueOf(20536)) },
            ...
            { assertThat(resultat.resultatPeriodeListe[5].resultat.belop).isEqualTo(BigDecimal.valueOf(20063)) },
    ...
    fun testGrunnlagMedAvvik() {
        ...
        assertAll(
            ...
            { assertThat(avvikListe[3].avvikTekst).isEqualTo("Siste dato i bostatusPeriodeListe (2020-01-01) er før beregnDatoTil (2021-01-01)") },
            ...
            { assertThat(avvikListe[4].avvikType).isEqualTo(Avvikstype.PERIODE_MANGLER_DATA) },
            { assertThat(avvikListe[5].avvikTekst).isEqualTo("Siste dato i saerfradragPeriodeListe (2020-01-01) er før beregnDatoTil (2021-01-01)") },
            { assertThat(avvikListe[5].avvikType).isEqualTo(Avvikstype.PERIODE_MANGLER_DATA) },
        )
    }
    ...
    private fun lagSjablonGrunnlag(): List<SjablonPeriode> {
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                sjablonPeriode = Periode(datoFom = LocalDate.parse("2003-01-01"), datoTil = LocalDate.parse("2013-01-01")),
                sjablon = Sjablon(
