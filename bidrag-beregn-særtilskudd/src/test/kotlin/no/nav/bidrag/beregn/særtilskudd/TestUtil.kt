...
object TestUtil {
    ...
    const val NETTO_SÆRTILSKUDD_REFERANSE = "NETTO_SÆRTILSKUDD_REFERANSE"
    ...
    private fun tilJsonNodeInnhold(`object`: Any?): JsonNode {
...
//                ),
//            )
//        return Grunnlag(BIDRAGSEVNE_REFERANSE, Grunnlagstype.BIDRAGSEVNE, objectMapper.valueToTree(bidragsevne))
//    }

    // Bygger opp BeregnBidragsevneResultatCore
    fun dummyBidragsevneResultatCore(): BeregnBidragsevneResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.særtilskudd.core.bidragsevne.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.særtilskudd.core.bidragsevne.dto.ResultatPeriodeCore(
                periode = PeriodeCore(datoFom = LocalDate.parse("2020-08-01"), datoTil = LocalDate.parse("2020-09-01")),
                resultat = no.nav.bidrag.beregn.særtilskudd.core.bidragsevne.dto.ResultatBeregningCore(BigDecimal.valueOf(100)),
...
//    }
    ...
    fun dummyBPsAndelSaertilskuddResultatCore(): BeregnBPsAndelSaertilskuddResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.særtilskudd.core.bpsandelsaertilskudd.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.særtilskudd.core.bpsandelsaertilskudd.dto.ResultatPeriodeCore(
                periode = PeriodeCore(datoFom = LocalDate.parse("2020-08-01"), datoTil = LocalDate.parse("2020-09-01")),
                resultatBeregning = no.nav.bidrag.beregn.særtilskudd.core.bpsandelsaertilskudd.dto.ResultatBeregningCore(
                    resultatAndelProsent = BigDecimal.valueOf(10),
                    resultatAndelBelop = BigDecimal.valueOf(100),
                    barnetErSelvforsorget = false,
                ),
                beregnedeGrunnlag = BeregnedeGrunnlagCore(inntektBPListe = emptyList(), inntektBMListe = emptyList(), inntektBBListe = emptyList()),
        ...
        return BeregnBPsAndelSaertilskuddResultatCore(
...
//    fun dummySamværsfradragResultat(): Grunnlag {
//        val objectMapper = ObjectMapper()
//        val samvaersfradrag =
//            SamværsfradragResultatPeriode(
//                LocalDate.parse("2020-08-01"),
//                LocalDate.parse("2020-09-01"),
//                BigDecimal.valueOf(100),
//                1,
...
//    }
    ...
    fun dummySamværsfradragResultatCore(): BeregnSamvaersfradragResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.særtilskudd.core.samvaersfradrag.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.særtilskudd.core.samvaersfradrag.dto.ResultatPeriodeCore(
                periode = PeriodeCore(LocalDate.parse("2020-08-01"), LocalDate.parse("2020-09-01")),
                resultatBeregningListe = listOf(
                    no.nav.bidrag.beregn.særtilskudd.core.samvaersfradrag.dto.ResultatBeregningCore(
                        barnPersonId = 1,
                        belop = BigDecimal.valueOf(100),
                    ),
                ),
                grunnlagReferanseListe = listOf(SAMVÆRSFRADRAG_REFERANSE),
            ),
        )
