...
object TestUtil {
    ...
    fun dummyBidragsevneResultatCore(): BeregnBidragsevneResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.core.bidragsevne.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.core.bidragsevne.dto.ResultatPeriodeCore(
                PeriodeCore(LocalDate.parse("2020-08-01"), LocalDate.parse("2020-09-01")),
                no.nav.bidrag.beregn.core.bidragsevne.dto.ResultatBeregningCore(BigDecimal.valueOf(100)),
                arrayListOf(
                    INNTEKT_REFERANSE,
                    SKATTEKLASSE_REFERANSE,
                    BOSTATUS_REFERANSE,
    ...
    fun dummyBPsAndelSaertilskuddResultatCore(): BeregnBPsAndelSaertilskuddResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.core.bpsandelsaertilskudd.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.core.bpsandelsaertilskudd.dto.ResultatPeriodeCore(
                PeriodeCore(LocalDate.parse("2020-08-01"), LocalDate.parse("2020-09-01")),
                no.nav.bidrag.beregn.core.bpsandelsaertilskudd.dto.ResultatBeregningCore(
                    BigDecimal.valueOf(10),
                    BigDecimal.valueOf(100),
                    false,
                ),
    ...
    fun dummySamvaersfradragResultatCore(): BeregnSamvaersfradragResultatCore {
        val bidragPeriodeResultatListe = ArrayList<no.nav.bidrag.beregn.core.samvaersfradrag.dto.ResultatPeriodeCore>()
        bidragPeriodeResultatListe.add(
            no.nav.bidrag.beregn.core.samvaersfradrag.dto.ResultatPeriodeCore(
                PeriodeCore(LocalDate.parse("2020-08-01"), LocalDate.parse("2020-09-01")),
                listOf(no.nav.bidrag.beregn.core.samvaersfradrag.dto.ResultatBeregningCore(1, BigDecimal.valueOf(100))),
                arrayListOf(
                    SAMVAERSFRADRAG_REFERANSE,
                ),
            ),
