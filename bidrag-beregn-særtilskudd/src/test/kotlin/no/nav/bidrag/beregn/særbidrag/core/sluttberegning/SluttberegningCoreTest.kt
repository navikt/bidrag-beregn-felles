...
internal class SluttberegningCoreTest {
    ...
    private lateinit var saertilskuddCoreWithMock: SærbidragCore
    private lateinit var saertilskuddCore: SærbidragCore
    ...
    fun initMocksAndService() {
        saertilskuddCoreWithMock = SærbidragCore(særbidragPeriodeMock)
        val særbidragBeregning = SærbidragBeregning()
        val særbidragPeriode = SærbidragPeriode(særbidragBeregning)
        saertilskuddCore = SærbidragCore(særbidragPeriode)
    }
    ...
    fun skalBeregneSaertilskudd() {
        ...
        `when`(særbidragPeriodeMock.beregnPerioder(any())).thenReturn(beregnSaertilskuddPeriodeResultat)
