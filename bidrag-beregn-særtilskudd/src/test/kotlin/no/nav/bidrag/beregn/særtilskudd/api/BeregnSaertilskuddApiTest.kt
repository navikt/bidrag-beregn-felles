package no.nav.bidrag.beregn.særtilskudd.api
...
import no.nav.bidrag.beregn.særtilskudd.testdata.SjablonApiStub
...
internal class BeregnSaertilskuddApiTest {
    ...
    @Mock
    private lateinit var beregnSærtilskuddService: BeregnSærtilskuddService

    @BeforeEach
    fun initMock() {
        SjablonApiStub().settOppSjablonStub()
        beregnSærtilskuddService = BeregnSærtilskuddService()
    }
    ...
    private fun utfoerBeregningerOgEvaluerResultat_EttSoknadsbarn() {
        ...
        val totalSærtilskuddResultat = beregnSærtilskuddService.beregn(request)
